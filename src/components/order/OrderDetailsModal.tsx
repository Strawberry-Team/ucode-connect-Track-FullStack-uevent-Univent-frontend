                            ...
                            <div className="px-2 space-y-2">
                                ...
                                {hasDiscount && (
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-green-600">{(order.promoCode.discountPercent * 100).toFixed(0)}% off</span>
                                    </div>
                                )}
                                <div className="flex items-center gap-2">
                                            ...
                                            >
                                                <div className="flex-1 space-y-1">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="border px-2 rounded-md bg-gray-100 text-gray-700 border-gray-300">
                                                            {item.ticket.title}
                                                        </span>
                                                    </div>
                                                    <div className="text-sm text-gray-600">
                                                        <Wallet strokeWidth={2.5} className="inline -mt-1 h-5 w-5 text-gray-500" />
                                                        {hasDiscount ? (
                                                            <>
                                                            ...
                                                            <span className="pl-2">
                                                                <DollarSign className="inline -mt-1 h-4 w-4 text-gray-600" />
                                                                {item.finalPrice.toFixed(2)}
                                                            </span>
                                                        )}
                                                    </div>
